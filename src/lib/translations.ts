...
export const t: Record<Language, TranslationKeys> = {
  en: {
    ...
    sectionHealthCheck: "Resilience Check",
    ...
    sectionRecent: "Recent Money Moves",
    viewAll: "VIEW ALL",
    resModalTitle: "Resilience Score",
    resModalExcellent: "Strong",
    resModalStable: "Healthy",
    resModalNeedsAttention: "Needs Control",
    resModalDesc: "Your Resilience Score shows how ready your money is for the rest of the month.",
    ...
    reportSubheader: "Safe Daily Spend, Resilience Score, and spending patterns.",
  ...
  ms: {
    ...
    actionShield: "Smart Lock",
    sectionHealthCheck: "Semakan Resilience",
    ...
    sectionRecent: "Money Move Terkini",
    viewAll: "LIHAT SEMUA",
    resModalTitle: "Resilience Score",
    ...
    reportHeader: "Insights",
    reportSubheader: "Trend Safe Daily Spend, Resilience Score, dan kategori.",
