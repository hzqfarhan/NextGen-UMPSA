...
export const t: Record<Language, TranslationKeys> = {
  en: {
    ...
    saveEditPocket: "Edit Savings Goal",
    saveDeletePocket: "Delete Savings Goal",
    saveDeleteConfirm: "Are you sure?",
    saveDeleteNotice: "The balance in this pocket will return to your main account.",
    saveUpdatePocket: "Update Savings Goal",
    ...
    reportMilestones: "Savings Progress",
  ...
  ms: {
    ...
    insightSavings: "Matlamat Simpanan",
    ...
    saveHeader: "Matlamat Simpanan",
    saveSubheader: "Misi kecil, streak, dan future-you wins.",
    saveTotalLabel: "Jumlah Simpanan",
    saveActiveGoals: "Simpanan Aktif",
    savePocketEmerg: "Emergency Pocket",
    savePocketLaptop: "Matlamat Laptop",
    savePocketRent: "Rent Buffer",
    saveGoalMet: "Matlamat Selesai",
    saveCreatePocket: "Cipta Matlamat",
    saveSplitSummary: "Simpanan dibahagi antara {count} pocket (RM {amount} setiap satu)",
    saveMode: "Mod Simpanan",
    ...
    saveAddFunds: "TAMBAH",
    saveAddPocket: "Matlamat Simpanan Baharu",
    ...
    saveEditPocket: "Edit Matlamat",
    saveDeletePocket: "Padam Matlamat",
    saveDeleteConfirm: "Anda pasti?",
    saveDeleteNotice: "Baki pocket ini akan kembali ke akaun utama.",
    saveUpdatePocket: "Kemaskini Matlamat",
    reportHeader: "Insights",
    reportSubheader: "Trend Safe Daily Spend, NextGen Score, dan kategori.",
    reportBreakdown: "Kategori Belanja",
    reportMilestones: "Kemajuan Simpanan",
    reportMileEmerg: "Emergency Pocket 50%",
